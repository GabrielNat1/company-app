...
const eventRegistrationsData = [
  { name: 'Tech Conference', registrations: 156 },
  { name: 'Product Launch', registrations: 89 },
  { name: 'Workshop', registrations: 45 },
  { name: 'Webinar', registrations: 78 },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md transition-colors">
          <h3 className="text-lg font-semibold mb-4 dark:text-white">Event Registrations</h3>
          <div className="h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
